...
{
	$ofn=$_REQUEST['ofn'];
		$sql="select id,name,doc_no,doc_loc,doc_type from docs where ".$ofn."a=1";
	$c=0;
	$message="";
	$rslt=$cnn->query($sql);
	echo "<center><table><tr><td><b>Id<b></td><td><b>Num<b></td><td><b>Name<b></td><td><b>Type<b></td><td><b>Link<b></td></tr>";
	if($rslt->num_rows>0)
	{
		$c=$rslt->num_rows;
		
		$message="You have accepted ".$c." file(s).";
	...
	echo "<h3>You have accepted ".$c." file(s).</h3>";
}
else{
